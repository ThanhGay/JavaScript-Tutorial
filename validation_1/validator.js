...
Validator.match = function (selector, message, confirmValue) {
    return {
        selector: selector,
        test: function (value) {
            return value === confirmValue() ? undefined : message || 'Nhập vào không chính xác';
        }
    }
}

Validator.onsubmit = function (e) {
    // e.preventDefault();
}